...
<div class="jumbotron text-center" style="margin-bottom:0; " id="banner">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- The Modal -->
            <div class="modal fade" id="Gears">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">Gears of War 4</h4>
                        ...
                        <div class="modal-body" id="modal_contenido"
                            ...
                            <div class="text-center text-sm text-dark" id="Gears">
                                ...
                                <p>Pan molido</p>
                                <p>Aceite</p>
                                <h2 class="text-lg-center text-warning">Gears</h2>
                                <p>
            ...
            <div class="col-4 shake-rotate" id="GTAV">
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        <a href="" data-toggle="modal" data-target="#modalEnsalada">
                            <div class="" align="center">
                                <br>
                                <img clas="img-responsive imgreceta" src="https://images-na.ssl-images-amazon.com/images/I/71SJqUljaBL._AC_SX215_.jpg" style="width: 90%"
                                     id="img_ensalada">
                                <span></span>
                            </div>
                        </a>
                        <p class="text-center tituloReceta" style="height: 22px;">GTAV</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="GTAV">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">GTAV</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
                        ...
                        <div class="modal-body" id="modal_contenido"
                            ...
                            <div class="text-center text-sm text-dark" id="GTAV">
                                <h2 class="h2 text-xl-center text-danger">Ingredientes</h2>
            ...
            <div class="col-4 shake-rotate" id="">
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        ...
                        <p class="text-center tituloReceta" style="height: 22px;">HALO</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
            ...
            <div class="modal fade" id="HALO">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">HALO</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>

                        <!-- Modal body -->
                        <div class="modal-body" id="HALO"
                             style="background-image: url('img/fondo_modal.jpg')">

                            <div class="text-center text-sm text-dark" id="HALO">
                                <h2 class="h2 text-xl-center text-danger">Ingredientes</h2>
            ...
            <div class="col-4 shake-vertical" id="">
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        ...
                        <p class="text-center tituloReceta" style="height: 22px;">ADVENTURES</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
                ...
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        <a href="" data-toggle="modal" data-target="#modalPlatano">
                            <div class="" align="center">
                                <br>
                                <img clas="img-responsive imgreceta" src="https://i11d.3djuegos.com/juegos/6240/kinect_adventures/fotos/ficha/kinect_adventures-1721595.jpg"
                                     style="width: 90%">
                                <span></span>
                            </div>
                        </a>
                        <p class="text-center tituloReceta" style="height: 22px;">ADVENTURE</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
            ...
            <div class="modal fade" id="modalPlatano">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">ADVENTURE</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
            ...
            <div class="modal fade" id="modalBurritos">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">MINECRAFT</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
                ...
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        <a href="" data-toggle="modal" data-target="#modalPambazo">
                            <div class="" align="center">
                                <br>
                                <img clas="img-responsive imgreceta" src="https://www.xoneoff.com/62-large_default/outlast-bundle-of-terror.jpg" style="width: 90%">
                                <span></span>
                            </div>
                        </a>
            ...
            <div class="modal fade" id="modalPambazo">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">OUTLAST</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
                        ...
                        <div class="modal-body" id="modal_contenido"
                            ...
                            <div class="text-center text-sm text-dark" id="croquetas">
                                <h2 class="h2 text-xl-center text-danger">OUTLAST</h2>
                ...
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        <a href="" data-toggle="modal" data-target="#modalChilaquiles">
                            <div class="" align="center">
                                <br>
                                <img clas="img-responsive imgreceta" src="https://mlstaticquic-a.akamaihd.net/planet-coaster--D_NQ_NP_895254-MLU26546892486_122017-F.jpg"
                                     style="width: 90%">
                                <span></span>
                            </div>
                        </a>
                        <p class="text-center tituloReceta" style="height: 44px;">PLANET COASTER</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
            ...
            <div class="modal fade" id="modalChilaquiles">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">PLANET COASTER</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
            ...
            <div class="col-4 shake-horizontal" id="">
                <div class="card-body">
                    <div class="col-md-22 bwhite center-block shadow  margin-right-10">
                        ...
                        <p class="text-center tituloReceta" style="height: 44px;">POKEMON OMEGA RUBY</p>
                        <div class="col-md-12 ratingStar text-right nopadding">
            ...
            <div class="modal fade" id="modalSalpicon">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                            <h4 class="modal-title text-lg-left" style="font-family: Century;">POKEMON OMEGA RUBY</h4>
                            <button type="button" class="close" data-dismiss="modal">×</button>
                        </div>
